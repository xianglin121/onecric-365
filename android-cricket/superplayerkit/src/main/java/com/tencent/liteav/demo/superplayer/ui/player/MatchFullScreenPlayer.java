 ...
 */
public class MatchFullScreenPlayer extends AbsPlayer implements View.OnClickListener,
    ...
    public MatchFullScreenPlayer(Context context) {
        super(context);
        initialize(context);
    }

    public MatchFullScreenPlayer(Context context, AttributeSet attrs) {
        super(context, attrs);
        initialize(context);
    }

    public MatchFullScreenPlayer(Context context, AttributeSet attrs, int defStyleAttr) {
...
//                    mSeekBarProgress.setProgress(progress);
    ...
    private void initView(Context context) {
        ...
        LayoutInflater.from(context).inflate(R.layout.superplayer_vod_player_match_fullscreen, this);
...
//        }
    ...
    private static class HideLockViewRunnable implements Runnable {
        private WeakReference<MatchFullScreenPlayer> mWefControllerFullScreen;

        public HideLockViewRunnable(MatchFullScreenPlayer controller) {
