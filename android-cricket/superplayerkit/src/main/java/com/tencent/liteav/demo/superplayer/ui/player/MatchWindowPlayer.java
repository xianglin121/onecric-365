 ...
 */
public class MatchWindowPlayer extends AbsPlayer implements View.OnClickListener,
...
//    private TextView mTvPeopleCount;                           // 观看人数
    ...
    public MatchWindowPlayer(Context context) {
        super(context);
        initialize(context);
    }

    public MatchWindowPlayer(Context context, AttributeSet attrs) {
        super(context, attrs);
        initialize(context);
    }

    public MatchWindowPlayer(Context context, AttributeSet attrs, int defStyleAttr) {
...
//                    mSeekBarProgress.setProgress(progress);
    ...
    private void initView(Context context) {
        LayoutInflater.from(context).inflate(R.layout.superplayer_vod_player_match_window, this);
    ...
    public void setWatermark(final Bitmap bmp, float x, float y) {
        ...
        if (bmp != null) {
            this.post(new Runnable() {
                @Override
                public void run() {
                    int width = MatchWindowPlayer.this.getWidth();
                    int height = MatchWindowPlayer.this.getHeight();
