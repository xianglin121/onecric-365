 ...
 * 时间：2021/11/23
 */
public class VodQualityFullScreenView extends RelativeLayout implements View.OnClickListener {
    ...
    public VodQualityFullScreenView(Context context) {
        super(context);
        init(context);
    }

    public VodQualityFullScreenView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public VodQualityFullScreenView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context) {
        mContext = context;
        LayoutInflater.from(mContext).inflate(R.layout.superplayer_vod_quality_full_screen, this);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.tv_quality_one) {
            if (mCallBack != null) {
